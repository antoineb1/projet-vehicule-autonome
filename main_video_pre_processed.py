...
def browse_file(): #appelée lorsque l'utilisateur clique sur le bouton "Choisissez une photo à analyser"
    file_path = filedialog.askopenfilename() #pour ouvrir une fenêtre de dialogue de sélection de fichier
...
video = cv2.VideoCapture(filepath) # J'ai remplacé video1.avi par le filepath
